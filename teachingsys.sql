/*
 ...
 Source Schema         : teachingsys

 Target Server Type    : MySQL
 Target Server Version : 50528
 File Encoding         : 65001

 Date: 19/11/2019 22:18:00
*/
...
CREATE TABLE `category`  (
  ...
  `cate_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `course_books`  (
  ...
  `support` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `personal_time` date DEFAULT NULL,
  `personal_level` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `edu_ref`  (
  ...
  `personal_time` date DEFAULT NULL,
  `personal_level` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `inschool_expre`  (
  ...
  `support` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `personal_time` date DEFAULT NULL,
  `personal_level` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `personal_teacher`  (
  ...
  CONSTRAINT `personal_teacher_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `sys_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `sys_service`  (
  ...
  `textarea` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
